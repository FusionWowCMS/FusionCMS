...
<html>
	<head>
		...
		<script src="./../application/vendor/node_modules/jquery/dist/jquery.min.js"></script>
										...
										<section class="box big step" data-validation="requirements" style="display:none;">
											...
											<div class="introduction text-muted-500">
												...
												<div class="php-version">
													...
													{{minimum_required_php}}: <span class="bg-muted-200 dark:bg-muted-700 text-muted-500 dark:text-muted-200 h-7 w-auto items-center justify-center rounded-full text-xs p-1">8.1.0</span> <span class="check-result"></span>
												</div>
