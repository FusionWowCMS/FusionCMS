<div class="card" id="add_item">
	<div class="card-header"><a href='{$url}store/admin_items' data-toggle="tooltip" data-placement="top" title="{lang('return', 'store')}">{lang('groups', 'store')}</a> &rarr; {lang('new_group', 'store')}</div>
	<div class="card-body">
		<form onSubmit="Items.create(this, true); return false">
			<div class="form-group row">
				...
				<div class="col-sm-6 mb-3">
					<label class="col-form-label" for="order" data-tip="{lang('group_order_tip', 'store')}">{lang('group_order', 'store')}</label>
