<div class="card">
	<div class="card-header"><a href='{$url}store/admin_items' data-bs-toggle="tooltip" data-placement="top" title="{lang('return', 'store')}">{lang('groups', 'store')}</a> &rarr; {lang('edit_group', 'store')}</div>
	<div class="card-body">
		<form onSubmit="Items.editGroup({$group.id}, this); return false">
			<div class="form-group row">
				<div class="col-sm-6 mb-3">
					<label class="col-form-label" for="title">{lang('group_name', 'store')}</label>
				...
				<div class="col-sm-6 mb-3">
					<label class="col-form-label" for="icon">{lang('group_icon', 'store')}</label>
				...
				<div class="col-sm-6 mb-3">
					<label class="col-form-label" for="order" data-bs-toggle="tooltip" data-placement="top" title="{lang('group_order_tip', 'store')}">{lang('group_order', 'store')}</label>
