		...
		<div class="border-muted-200 dark:border-muted-700 dark:bg-muted-800 relative w-full border bg-white transition-all duration-300 rounded-xl p-4">
			<div class="mb-3 flex items-center gap-3">
				...
				<div class="leading-none">
					<h4 class="text-muted-800 dark:text-muted-100 font-sans text-sm font-medium">{lang('author', 'admin')}: {$manifest.author}</h4>
					<p class="text-muted-400 font-sans text-xs">{lang('date', 'admin')}: {if isset($manifest.date)} {$manifest.date} {else} 2023-01-01 {/if}</p>
				</div>
			</div>
			...
			<div class="my-4 flex items-center justify-between">
				<div>
					...
					<div class="text-muted-400 flex items-center gap-1">
						...
						<p class="font-sans text-sm">{lang('version', 'admin')}: {if isset($manifest.version)} {$manifest.version} {else} 1.0.0 {/if}</p>
					</div>
				</div>
				<div>
					<div class="flex">
						<div class="dark:bg-muted-800 relative flex shrink-0 items-center justify-center rounded-full bg-white transition-all duration-100 ease-in h-8 w-8 hover:-ms-2 hover:me-2 focus:-ms-2 focus:me-2">
							<div class="relative inline-flex shrink-0 items-center justify-center outline-none h-8 w-8 rounded-full bg-primary-500/20 text-primary-500 !scale-90" tooltip="{lang('html5', 'admin')}" data-tooltip="{lang('html5', 'admin')}">
								<div class="flex h-full w-full items-center justify-center overflow-hidden text-center transition-all duration-300 rounded-full">
						...
						<div class="dark:bg-muted-800 relative flex shrink-0 items-center justify-center rounded-full bg-white transition-all duration-100 ease-in h-8 w-8 hover:-ms-2 hover:me-2 focus:-ms-2 focus:me-2 -ms-2 hover:-ms-4 hover:me-2 focus:-ms-4 focus:me-2">
							<div class="relative inline-flex shrink-0 items-center justify-center outline-none h-8 w-8 rounded-full bg-primary-500/20 text-primary-500 !scale-90" tooltip="{lang('javascript', 'admin')}" data-tooltip="{lang('javascript', 'admin')}">
								<div class="flex h-full w-full items-center justify-center overflow-hidden text-center transition-all duration-300 rounded-full">
						...
						<div class="dark:bg-muted-800 relative flex shrink-0 items-center justify-center rounded-full bg-white transition-all duration-100 ease-in h-8 w-8 hover:-ms-2 hover:me-2 focus:-ms-2 focus:me-2 -ms-2 hover:-ms-4 hover:me-2 focus:-ms-4 focus:me-2">
							<div class="relative inline-flex shrink-0 items-center justify-center outline-none h-8 w-8 rounded-full bg-primary-500/20 text-primary-500 !scale-90" tooltip="{lang('css', 'admin')}" data-tooltip="{lang('css', 'admin')}">
								<div class="flex h-full w-full items-center justify-center overflow-hidden text-center transition-all duration-300 rounded-full">
