<section class="card" id="main_link">
	<header class="card-header">
		{lang('languages', 'admin')} (<div style="display:inline;" id="logs_count">{if !$languages}0{else}{count($languages)}{/if}</div>)
	</header>
