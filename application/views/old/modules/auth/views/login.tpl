    ...
    <form onSubmit="Auth.login(true); return false;">
        <div class="card-body">
            ...
            <div class="input-group p-0 flex-row">
                <input type="text" class="form-control username-input border-0" name="username" placeholder="{lang('login_label_user', 'auth')}" aria-describedby="username">
            </div>

            <div class="input-group p-0 mt-3 flex-row">
                <input type="password" class="form-control password-input border-0" name="password" placeholder="{lang('login_label_password', 'auth')}" aria-describedby="password">
            </div>
