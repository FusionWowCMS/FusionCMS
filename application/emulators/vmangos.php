...
class Vmangos implements Emulator
{
    protected $config;
    ...
    protected array $queries = [
        ...
        "get_guild" => "SELECT guild_id guildid, name guildName, leader_guid leaderguid, motd motd, info info, create_date createdate FROM guild WHERE guild_id = ?"
    ];
