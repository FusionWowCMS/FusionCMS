...
class Skyfire_old implements Emulator
{
    ...
    protected array $queries = [
        ...
        "get_guild" => "SELECT guildid guildid, name guildName, leaderguid leaderguid, motd motd, createdate createdate, level level, experience experience FROM guild WHERE guildid = ?"
    ];
