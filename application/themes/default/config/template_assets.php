...
$assets = [
    'css' => [
        ...
        'parts' => [
            ...
            'module' => [
                'name'  => strtolower(CI::$APP->router->fetch_module()) . '.min.css',
                'files' => str_replace(CMS_ROOT_PATH, base_url(), glob(T_ROOT_PATH . 'modules' . DS . strtolower(CI::$APP->router->fetch_module()) . DS . 'css' . DS . '*.css'))
            ]
        ]
    ],
    ...
    'js' => [
        ...
        'parts' => [
            'all' => [
                ...
                'files' => array_merge(
                    [
                        ...
                        # Theme javascript files (Base libraries)
                        T_ROOT_PATH . 'assets' . DS . 'node_modules' . DS . 'icheck' . DS . 'icheck.min.js',
                        T_ROOT_PATH . 'assets' . DS . 'node_modules' . DS . 'selectbox' . DS . 'selectbox.js',
            ...
            'module' => [
                'name'  => strtolower(CI::$APP->router->fetch_module()) . '.min.js',
                'files' => str_replace(CMS_ROOT_PATH, base_url(), glob(T_ROOT_PATH . 'modules' . DS . strtolower(CI::$APP->router->fetch_module()) . DS . 'js' . DS . '*.js'))
            ]
        ]
    ]
];
