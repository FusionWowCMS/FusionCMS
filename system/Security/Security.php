...
class Security
{
    ...
    public function __construct()
    {
        ...
        $this->CSRFEnabled     = config_item('csrf_protection');
        $this->CSRFExpire      = config_item('csrf_expire');
        $this->CSRFTokenName   = config_item('csrf_token_name');
        $this->CSRFCookieName  = config_item('csrf_cookie_name');
        $this->CSRFRegenerate  = config_item('csrf_regenerate');
        $this->CSRFExcludeURIs = config_item('csrf_exclude_uris');

        if (config_item('cookie_prefix') !== null)
        {
            $this->CSRFCookieName = config_item('cookie_prefix').config_item('csrf_cookie_name');
        }
